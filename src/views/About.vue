  ...
  <div class="about">
    ...
    <div class="bio contained">
      ...
      <div class="about-container">
        ...
        <p v-scroll-reveal class="regular first-sentence">I am a user experience designer based in Houston, Texas, currently working at Credera. I’ve touched everything from circuit design to back-end API architecture to front-end development but now focus on building desirable experiences through design. </p>
