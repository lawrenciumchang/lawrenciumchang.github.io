<template>
  <div class="introduction">
    <p v-scroll-reveal class="regular first-sentence">Hey there, I'm Lawrence. Associate Design Director at Credera by <span class="icon icon-day"></span>. Product Design Director at Clackd by <span class="icon icon-night"></span>.</p>
...
.introduction {
  ...
  .icon-day {
    background: url('/assets/icons/icon-day.svg') no-repeat;
  }
